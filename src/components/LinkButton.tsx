...
export default function LinkButton({ label, href, icon }: SocialLink) {
  return (
    <GlassCapsule>
      <Link href={href} target="_blank" className="w-full px-4 py-3 flex items-center justify-between text-white">
        <span>{label}<Link.Icon /></span>
        {icons[icon]}
      </Link>
    </GlassCapsule>
  );
